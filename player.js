...
(() => {
  ...
  const ICONS = {
    ...
    note: '<svg viewBox="0 0 24 24"><ellipse cx="8" cy="17" rx="4.5" ry="3.5" transform="rotate(-12 8 17)"/><path d="M10 5C10.5 3 12.5 2 14.5 2.5C16.5 3 17.7 5 17.3 7C17 9 15.5 10 14 9.5C14.5 8 14.8 7 14.5 5.8C14 4.5 13 4 12 4L12 17L10 17Z"/></svg>',
